...
var introduction = "<br><p style='font-size:25px;'>Here you can see your achievements:</p><br><br>";
...
if(localStorage['nextLevel'] == undefined) localStorage['nextLevel'] = 0;

var wonLevel = "<p style='font-size:23px;'>Completed level: "+ localStorage['winN']+"</p><br>";
var losedLevel = "<p style='font-size:23px;'>Lost level: "+ localStorage['lostN']+"</p><br>";
var gametime = "<p style='font-size:23px;'>Entire playtime: "+ min10 + "" + min1 + ":" + sec10 + "" + sec1 +"</p><br>";
